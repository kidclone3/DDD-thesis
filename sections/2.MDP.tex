...
Khung thời gian là \([0, 5]\). Hầu hết các cung có điểm dừng là số
...
\caption{Biểu đồ đường cho Hàm thời gian di chuyển.}
\label{fig:4}
...
\item
  ...
  \(\overline{\mathcal B}^{3.89}\) do không còn điểm dừng.
\item
