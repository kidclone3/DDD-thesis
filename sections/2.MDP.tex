...
\subcaptionbox{Cung \((1,2)\)\label{fig:4a}}{\includegraphics[width=.32\textwidth]{plot/Arc (1,2).png}}
\subcaptionbox{Cung \((1,3)\)\label{fig:4b}}{\includegraphics[width=.32\textwidth]{plot/Arc (1,3).png}}
\subcaptionbox{Cung \((2,3)\)\label{fig:4c}}{\includegraphics[width=.32\textwidth]{plot/Arc (2,3).png}}

\subcaptionbox{Cung \((2,4)\)\label{fig:4d}}{\includegraphics[width=.32\textwidth]{plot/Arc (2,4).png}}
\subcaptionbox{Cung \((3,4)\)\label{fig:4e}}{\includegraphics[width=.32\textwidth]{plot/Arc (3,4).png}}
...
\subcaptionbox{ABSPT \(\overline{\mathcal{B}}^{2.57}\)\label{fig:5c}}{\includegraphics[width=.45\textwidth]{edited-images/Figure5c.jpg}}
\subcaptionbox{ABSPT \(\overline{\mathcal{B}}^{2.57}\) với các UTT khi ghép với \(B^5\)\label{fig:5d}}{\includegraphics[width=.45\textwidth]{edited-images/Figure5d.jpg}}
